    ...
    success: function(data){
      ...
      console.log(data)
        ...
        switch(background){
            ...
            case 'sunny':
            case 'mostlysunny':
                  $(".searchResults").css("background-image", "url('https://rawgit.com/navarrra/weatherBox/master/backgrounds/sunnyback.jpg')");
                break;

            case 'partlycloudy':
            case 'partlysunny':
                  $(".searchResults").css("background-image", "url('https://rawgit.com/navarrra/weatherBox/master/backgrounds/partlycloudyback.jpg')");
                break;

            case 'scatteredclouds':
                  $(".searchResults").css("background-image", "url('https://rawgit.com/navarrra/weatherBox/master/backgrounds/scatteredback.jpg')");
                break;

            case 'mostlycloudy':
            case 'cloudy':
                  $(".searchResults").css("background-image", "url('https://rawgit.com/navarrra/weatherBox/master/backgrounds/cloudyback.jpg')");
                break;

            case 'sleet':
            case 'rain':
                  $(".searchResults").css("background-image", "url('https://rawgit.com/navarrra/weatherBox/master/backgrounds/rainback.jpg')");
                break;

            case 'tstorms':
                  $(".searchResults").css("background-image", "url('https://rawgit.com/navarrra/weatherBox/master/backgrounds/tstormsback.jpg')");
                break;

            case 'snow':
            case 'flurries':
                  $(".searchResults").css("background-image", "url('https://rawgit.com/navarrra/weatherBox/master/backgrounds/snowback.jpg')");
                break;

            case 'fog':
            case 'hazy':
                  $(".searchResults").css("background-image", "url('https://rawgit.com/navarrra/weatherBox/master/backgrounds/fogback.jpg')");
                break;
                  ...
                  success: function(data){
                    ...
                    for(var i = 0 ; i < forecast.length; i++){
                        ...
                        var threeDay = forecast[i];
                         ...
                         var highf = "<h3> High: " +  threeDay[j].high.fahrenheit + "°" + "</h3><br>";
                         var lowf = "<h3> low: " +  threeDay[j].low.fahrenheit + "°" + "</h3>";
                         var highc = "<h3> High: " +  threeDay[j].high.celsius + "°" + "</h3><br>";
                         var lowc ="<h3> low: " +  threeDay[j].low.celsius + "°" + "</h3>";

                         if(type==true){
                           $("#weekday_short").append("<div class='result3Day'><h3>"+ days + "</h3><br><img class='icon_url3' src='"+ icon +"'>" + highf + lowf + "</div>");
                          }else{
                            $("#weekday_short").append("<div class='result3Day'><h3>"+ days + "</h3><br><img class='icon_url3' src='"+ icon +"'>" + highc + lowc + "</div>");
                          };//end of else
                                };
                              };
                          },
